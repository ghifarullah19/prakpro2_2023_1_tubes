...
public class PelangganModelTable extends AbstractTableModel {
    ...
    public PelangganModelTable(List<Pelanggan> data) {
    ...
    public Object getValueAt(int row, int col) {
        ...
        Pelanggan rowItem = data.get(row);
    ...
    public void add(Pelanggan value) {
    ...
    public void delete(Pelanggan value) {
        // Membuat variable i untuk menyimpan index dari data
        int i = 0;
