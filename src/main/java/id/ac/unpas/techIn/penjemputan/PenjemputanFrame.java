...
public class PenjemputanFrame
    ...
    // jenisMemberList adalah variabel yang digunakan untuk menyimpan data jenis
    // member
    private List<Penjemputan> penjemputanList;

    // jenisMemberDao adalah variabel yang digunakan untuk menyimpan data jenis
    // member yang didapat dari database
    ...
    public PenjemputanFrame(PenjemputanDao penjemputanDao) {
        ...
        // this.jenisMemberList diberikan nilai dari data jenis member yang didapat dari
        // database
        this.penjemputanList = this.penjemputanDao.findAll();

        initComponents();

        // showPermintaanPane.setLayout(new BoxLayout(showPermintaanPane,
        // BoxLayout.PAGE_AXIS));
